...
public class UncontrolledFlooding {
    public static void main(String[] args) {
		...
		// Define the adjacency matrix for a finite loop
		/* 
		...
		*/
		...
		boolean[][] adjacencyMatrix = {
            ...
            {false, false, false, true, false},
            {false, false, false, false, true},
            {false, true, false, false, false}   // D -> E -> B
        };
		...
		// Start the flooding algo from node A
		nodes[0].tell(new FloodMessage("Hey yo"), ActorRef.noSender());
